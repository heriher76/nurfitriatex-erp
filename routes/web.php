...
Route::group(['middleware' => ['verified']], function () {
    ...
    Route::get('/material-dashboard', [DashboardController::class, 'material_dashboard_index'])->name('material.dashboard')->middleware(['auth', 'XSS', 'revalidate']);
    ...
    Route::resource('categories', CategoriesController::class)->middleware(['auth', 'XSS', 'revalidate']);

    Route::resource('genres', GenreController::class)->middleware(['auth', 'XSS', 'revalidate']);
