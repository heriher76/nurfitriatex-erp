                        ...
                        <table class="table  mb-0 table-custom-style" data-repeater-list="items" id="sortable-table">
                            ...
                            <tbody class="ui-sortable" data-repeater-item>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo e(Form::select('category_id', $categories, '', ['class' => 'form-control select2 item', 'required' => 'required'])); ?>

                                    </td>
                                    <td>
                                        <?php echo e(Form::select('genre_id', $genres, '', ['class' => 'form-control select2 item', 'required' => 'required'])); ?>
