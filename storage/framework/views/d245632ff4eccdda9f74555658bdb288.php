<?php $__env->startSection('page-title'); ?>
    <?php echo e(__('Manage Genre')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('breadcrumb'); ?>
    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
    <li class="breadcrumb-item"><?php echo e(__('Genres')); ?></li>
<?php $__env->stopSection(); ?>
<?php $__env->startSection('action-btn'); ?>
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create constant tax')): ?>
            <a href="#" data-url="<?php echo e(route('genres.create')); ?>" data-ajax-popup="true" data-title="<?php echo e(__('Create Genre')); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('edit constant tax')): ?>
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="#" class="mx-3 btn btn-sm align-items-center"
                                                            data-url="<?php echo e(route('genres.edit', $genre->id)); ?>"
                                                            data-ajax-popup="true" data-title="<?php echo e(__('Edit Genre')); ?>"
                                                ...
                                                <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete constant tax')): ?>
                                                    <div class="action-btn bg-danger ms-2">
                                                        ...
                                                        <a href="#"
                                                            ...
                                                            data-confirm-yes="document.getElementById('delete-form-<?php echo e($genre->id); ?>').submit();">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/genres/index.blade.php ENDPATH**/ ?>