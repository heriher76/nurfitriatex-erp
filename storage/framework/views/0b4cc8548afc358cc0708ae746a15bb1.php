                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $bankAccountDetail; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bankAccount): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr class="font-style">
                                                        ...
                                                        <td><?php echo e(\Auth::user()->priceFormat($bankAccount->opening_balance)); ?>
                                            ...
                                            <tbody>
                                                <?php $__empty_1 = true; $__currentLoopData = $latestIncome; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $income): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                    <tr>
                                                        ...
                                                        <td><?php echo e(!empty($income->customer) ? $income->customer->name : '-'); ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <?php if($invoice->status == 0): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge status_badge bg-secondary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 1): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge status_badge bg-warning"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 2): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge status_badge bg-danger"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 3): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge status_badge bg-info"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php elseif($invoice->status == 4): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge status_badge bg-primary"><?php echo e(__(\App\Models\Invoice::$statues[$invoice->status])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php elseif($bill->status == 4): ?>
                                                                <span
                                                                    class="p-2 px-3 rounded badge bg-primary"><?php echo e(__(\App\Models\Bill::$statues[$bill->status])); ?></span>
                                                            <?php endif; ?>
                                                        </td>
                                                    </tr>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-info">
                                                        <?php echo e(\Auth::user()->priceFormat(\Auth::user()->todayExpense())); ?>
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-warning">
                                                        <?php echo e(\Auth::user()->priceFormat(\Auth::user()->incomeCurrentMonth())); ?>
                                            ...
                                            <div class="d-flex align-items-start mb-2">
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h4 class="mb-0 text-danger">
                                                        <?php echo e(\Auth::user()->priceFormat(\Auth::user()->expenseCurrentMonth())); ?>
                            ...
                            <div class="card">
                                <div class="card-header">
                                    <h5><?php echo e(__('Storage Limit')); ?>
                                        ...
                                        <small class="float-end text-muted"><?php echo e($users->storage_limit . 'MB'); ?> /
                                            <?php echo e($plan->storage_limit . 'MB'); ?></small>
                                    </h5>
                                </div>
                                <div class="card-body">
                                                ...
                                                <table class="table align-items-center mb-0 ">
                                                    <tbody class="list">
                                                        <tr>
                                                            <td>
                                                                ...
                                                                <p class="text-muted text-sm mb-0">
                                                                    <?php echo e(__('Invoice Generated')); ?></p>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h5 class="mb-0"><?php echo e(__('Total')); ?></h5>
                                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Paid')); ?>
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <h5 class="mb-0"><?php echo e(__('Total')); ?></h5>
                                                                <p class="text-muted text-sm mb-0"><?php echo e(__('Due')); ?>
                                                    ...
                                                    <tbody class="list">
                                                        <tr>
                                                            <td>
                                                                <h5 class="mb-0"><?php echo e(__('Total')); ?></h5>
                                                                <p class="text-muted text-sm mb-0">
                                                                    <?php echo e(__('Bill Generated')); ?></p>
