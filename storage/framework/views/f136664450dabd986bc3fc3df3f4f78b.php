    ...
    <div class="float-end">
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('create constant tax')): ?>
            <a href="#" data-url="<?php echo e(route('categories.create')); ?>" data-ajax-popup="true"
                data-title="<?php echo e(__('Create Category')); ?>" data-bs-toggle="tooltip" title="<?php echo e(__('Create')); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/MAMP/htdocs/erp-sakka/resources/views/categories/index.blade.php ENDPATH**/ ?>