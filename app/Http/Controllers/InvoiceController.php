...
class InvoiceController extends Controller
{
    ...
    public function create($customerId)
    {
        if(\Auth::user()->can('create invoice'))
        {
            ...
            return view('invoice.create', compact('projects', 'customers', 'invoice_number', 'product_services', 'category', 'customFields', 'customerId', 'categories', 'genres'));
        }
        else
        {
...
//                $invoiceProduct->discount    = isset($products[$i]['discount']) ? $products[$i]['discount'] : 0;
                ...
                $invoiceProduct->genre_id       = $products[$i]['genre_id'];
                $invoiceProduct->save();
